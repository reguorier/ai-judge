...
The current claim-support block covers a narrow but important failure family: a real and relevant source that reports association while the model states causation. In that case, the system reports verified citation status, relevant source status, contradicted claim support, and the failure code \texttt{overclaimed\_causation}.
...
Failure code & \texttt{overclaimed\_causation} \\
\bottomrule
\end{tabularx}
