...
The public repo includes the v3.3 COUNCIL-004 persona/trace tools, v3.2 evidence/dissent demo, v3.1 neuro-cognitive demo, hard truth mode, and the v2 scoring engine:
...
- v3.3 exposes 9 fixed MBTI-style seat personas and L1/L2/L3 citation tracing
...
| `seats --list` | List the 9 fixed COUNCIL-004 persona seats | < 1s |
| `seats --show grok` | Show one seat's MBTI, bias, and prompt injection | < 1s |
| `trace --demo` | Detect shared citation contamination across seats | < 1s |
| `trace --claim "..."` | Classify one claim as L1/L2/L3 evidence trace | < 1s |
