...
AI Judge is a closed-core commercial project. This repository is the private engineering source of truth unless the owner explicitly publishes a separate public-safe package.
...
- Public docs that say "closed-core", "private commercial runtime", or "public demo" accurately.
...
5. Search public docs for stale "open-source" wording and replace it with "closed-core", "private", or "public demo" as appropriate.
