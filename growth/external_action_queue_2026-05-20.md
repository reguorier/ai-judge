...
Prepared but not sent. Each action needs user confirmation because it posts, submits, emails, or DMs externally.

| Priority | Action | Destination | Prepared Asset | Confirmation Needed |
|---|---|---|---|---|
| P0 | Submit MiraclePlus application | https://www.miracleplus.com/apply/ | `miracleplus_application_pack_2026-05-20.md` | Yes |
