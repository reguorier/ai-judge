...
| Resonance Wave 003 | Eval4SD OpenReview packet pushed / login blocks upload / taxonomy issues posted | `growth/resonance_wave_003_eval_taxonomy_infra.md`, `papers/eval4sd2026/openreview_submission.md` |
...
- Eval4SD short/position paper path is the priority venue; the anonymous LaTeX/PDF packet and OpenReview form packet now live in `papers/eval4sd2026/`, and the actual upload is blocked only by OpenReview account login.
