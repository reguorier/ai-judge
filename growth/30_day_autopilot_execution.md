...
- The demo package includes eight reproducible reports, the default 100-case benchmark, and a hard 13-case launch benchmark.
...
- Eval4SD short/position paper path is the priority venue; the anonymous LaTeX/PDF packet and OpenReview form packet now live in `papers/eval4sd2026/`, and the actual upload is blocked by OpenReview account activation/moderation after repeated completed profile-registration loops. A support-path request was sent to Eval4SD organizers on 2026-05-19 asking whether to wait for activation, contact OpenReview support, or use an alternate submission route.
